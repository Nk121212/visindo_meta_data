...
<html>
				...
				<div class="col-lg-8">
					...
					<div class="card">
		              ...
		              <div class="card-body">
		              	...
		              	<button style="margin-bottom: 10px;" class="btn btn-sm btn-primary text-white float-right" href="<?=base_url()?>Main/modal_add_team" data-toggle="modal"> 
                <i class="bx bx-plus"></i> Tambah Team</button>

		              	<div class="table-responsive">
							<table class="table table-hover table-team text-center">
								<thead>
									<tr>
										<th>No</th>
										<th>Nama</th>
	...
	<script>
		$(function() {
		    var dataTable = $('.table-team').DataTable( {
		        ajax: {
		            url: "<?=base_url()?>ajax/team.json",
		            data: function(data){
		    ...
		    $('.form-filter').submit(function(e){
		        ...
		        $('.table-team').dataTable().fnDestroy();
	        ...
	        $('.table-team tbody').on('click', 'tr td a.del', function () {
	            //var data = table.row( this ).data();
	            var id = $(this).attr('id-team');

	            //alert(id);

	            swal("Anda yakin akan menghapus karyawan ini ?", {
	                buttons: {
	                    yes: {
	                        text: "Ya",
	                        value: "yes",
	                ...
	                switch (value) {
	                    ...
	                    case "yes":
	                        ...
	                        $.post("<?=base_url()?>Main/delete_team",
	                        {
	                            id: id,
	                        },
	                        function(resp){
